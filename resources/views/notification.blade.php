...
<div class="notiMainDiv">
    ...
    <div class="notiFrame">
        <div class="notiImage">
            <form action="/fileupload" method="post" enctype="multipart/form-data" class="dropzone" style="width: 100%; height: 100%; border-style: none !important; padding-top: 10px;" id="dropzone1">
                @csrf
