				...
				@endif
					<td class="firstCol">
						<div>
							...
							@else
							<form action="/fileupload" method="post" enctype="multipart/form-data" class="formCSRF dropzone" style="width: 100%; height: 60px; border-style: none !important;"  id="dropzone{{$item->id}}">
								@csrf
