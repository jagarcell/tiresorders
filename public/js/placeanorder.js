					...
					if(totalstock > 0){
						...
						row.innerHTML +=
							...
							'<td id="instock_' + row.id + '" class="secondCol borderBottom instock">' +
								...
								CallToConfirm + '</div>' +
							'</td>' +
							'<td id="qty1_' + row.id + '" class="thirdCol borderBottom"><input id="qty2_' + row.id + '" type="number" value="1" minvalue="0" class="alignRight qtyInput" oninput="qtyChange(this)"></td>' +
